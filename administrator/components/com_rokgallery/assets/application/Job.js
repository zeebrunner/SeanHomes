/*
 * @version   $Id: Job.js 10876 2013-05-30 06:23:01Z btowles $
 * @author    RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2015 RocketTheme, LLC
 * @license   http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */
((function(){this.Job=new Class({Implements:[Options,Events],options:{url:"",id:null},initialize:function(a){this.setOptions(a);
this.id=this.options.id;this.queue=null;this.request=new Request({url:this.options.url,onSuccess:this.success.bind(this)});this.processRequest=new Request({url:this.options.url,onSuccess:this.success.bind(this)});
