...
}},refresh:function(a){this.parent(a);var b=this.coords.box,c=this.coords.container;if(Browser.ie&&Browser.Engine.version<5&&this.currentHandle&&this.currentHandle.col===1){this.overlay.setStyle("width","100.1%").setStyle("width","100%");
