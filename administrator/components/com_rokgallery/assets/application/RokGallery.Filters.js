...
var b=c.getElements("li");b.each(function(d){d.addEvent("click",this.itemClick.bind(this,d));},this);},this);var a=Browser.ie?"keyup:stop":Browser.safari?"keydown:stop":"keypress:stop";
