...
}};if(typeof RokGallerySqueezeBox!="undefined"){RokGallery.SqueezeBox=RokGallerySqueezeBox;}Object.merge(Element.NativeEvents,{dragstart:2,drag:2,dragenter:2,dragleave:2,dragover:2,drop:2,dragend:2});
window.addEvent("domready",a.init);})());