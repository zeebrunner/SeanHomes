/*
 * @version   $Id: Scrollbar.js 10876 2013-05-30 06:23:01Z btowles $
...
if(Browser.safari){c=a.event["wheelDelta"+this.property.axis.capitalize()];b=c;}if(Browser.ie||Browser.opera){c=a.event.wheelDelta;b=this.options.direction=="vertical"?c:false;
