/*
 * @version   $Id: Tags.js 10876 2013-05-30 06:23:01Z btowles $
 * @author    RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2015 RocketTheme, LLC
 * @license   http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */
((function(){Event.definePseudo("stop",function(b,c,a){var e=b.value?b.value.replace(/\s/g,"").split(","):false;
var d=a[0];if(!b.event.test(/^key.+/)||(e&&e.contains(d.key))){d.stop();}c.apply(this,a);});this.Tags=new Class({Implements:[Events,Options],options:{input:".tags-add .add-input",container:".tags-list",list:".tags-list .tag",classes:[],layout:'<div class="tag-value"><span class="tag-name">{value}</span></div><div class="tag-erase"><span>x</span></div>',chars:(/^[\w\s-]+$/),onInsert:function(b,a){b.inject(this.container);
...
var a=Browser.ie?"keyup:stop":Browser.safari?"keydown:stop":"keypress:stop";this.input.addEvent(a+"(enter)",function(d){if(d.key=="enter"){this.addNew();
