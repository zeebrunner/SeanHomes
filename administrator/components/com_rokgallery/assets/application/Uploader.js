/*
 * @version   $Id: Uploader.js 10876 2013-05-30 06:23:01Z btowles $
 * @author    RocketTheme http://www.rockettheme.com
 * @copyright Copyright (C) 2007 - 2015 RocketTheme, LLC
 * @license   http://www.gnu.org/licenses/gpl-2.0.html GNU/GPLv2 only
 */
((function(){if(!this.Uploader){this.Uploader={};
}this.Uploader=new Class({Implements:[Options,Events],options:{url:""},initialize:function(b,a){this.options.url=RokGallerySettings.url;this.setOptions(a);
this.type=UploaderSupport.check();if(!this.type){return;}if(this.type=="Flash"){var c=RokGallerySettings.session;this.setOptions({url:this.options.url+"&"+RokGallerySettings.token+"=1&"+c.name+"="+c.id});
