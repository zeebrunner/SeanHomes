...
if (!defined('JOOMLA_ROKGALLERY_LIB')) {
    ...
    $header->addScriptPath(JPATH_ADMINISTRATOR . '/components/com_rokgallery/assets/js');
    $header->addScriptPath(JPATH_ADMINISTRATOR . '/components/com_rokgallery/assets/application');
    $header->addStylePath(JPATH_ADMINISTRATOR . '/components/com_rokgallery/assets/styles');
