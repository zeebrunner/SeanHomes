...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.8</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> New option 'Save IP to Database' in Properties &gt; Form Info &gt; Misc.</li>
			<li><span class="version-fixed">Fix</span> The submission 'Confirmed' field was showing the opposite value.</li>
		</ul>
