...
<div id="tabs">
    <ul id="adv_admin_tabs" class="nav nav-tabs">
    ...
    <table  style="border-bottom:1px solid #666666;" width="100%">
	  <tr>
        ...
        <th style="text-align:right">&nbsp;<a href="#" onclick="exportCSV();return(false);" title="<?php echo JText::_('RS1_ADMIN_SCRN_EXPORT_CSV_HELP');?>"><?php echo JText::_('RS1_ADMIN_SCRN_EXPORT_CSV');?></a>
	      &nbsp;|&nbsp;&nbsp;<a href="#" onclick="sendReminders('Email');return(false);" title="<?php echo JText::_('RS1_ADMIN_SCRN_REMINDERS_TOOLTIP');?>"><?php echo JText::_('RS1_ADMIN_SCRN_SEND_REMINDERS');?></a>
            ...
            <tr class="fe_admin_header">
              ...
              <td style="font-size:11px; text-align:right">
               ...
               <input readonly="readonly" name="enddateFilter" id="enddateFilter" type="hidden" 
                ...
                <select name="request_resourceFilter" id="request_resourceFilter" onchange="changeRequestResourceFilter();" style="font-size:11px; width:auto;"  >
	...
	<table style="border-bottom:1px solid #666666;" width="100%">
	  ...
	  <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
		...
		<tr class="fe_admin_header">
		  <th>&nbsp;</th>
		  <th colspan="8" style="text-align:right"><?php echo JText::_('RS1_INPUT_SCRN_RESOURCE_CATEGORIES');?>&nbsp;<select name="resource_categoryFilter" id="resource_categoryFilter"
	...
	?>  	
		...
		<tr class="fe_admin_header">
		  <th>&nbsp;</th>
		  <th colspan="7" style="text-align:right"><?php echo JText::_('RS1_ADMIN_SCRN_SERV_RESOURCE');?>&nbsp;<select name="service_resourceFilter" id="service_resourceFilter"
       ...
       ?>
        <tr class="<?php echo "row$k"; ?>">
          ...
          <td align="left"><a href="<?php echo $link; ?>"><u><?php echo JText::_(stripslashes($srv_row->name)); ?></a></td>
...
<?php
	...
	?> 
		...
		<thead>
            <tr class="fe_admin_header">
              <th align="left" >&nbsp;</th>
              <th style="text-align:right" colspan="8"><?php echo JText::_('RS1_ADMIN_SCRN_SERV_RESOURCE');?>&nbsp;<select name="bookoffs_resourceFilter" id="bookoffs_resourceFilter" 
              onchange="selectResource(<?php echo $tab ?>);" style="font-size:11px; width:auto" >
      ...
      <table cellpadding="4" cellspacing="0" border="0" class="adminlist" width="100%">
        ...
        <tr><td colspan="10">
            ...
            <div style="display: table-cell; padding-left:1px;">
                ...
                <div style="display: table-cell; padding-left:5px;">
                <a href="#" onclick="doSearch();" title="<?php echo JText::_('RS1_ADMIN_COUPON_LIST_SEARCH');?>"> <img height="16" hspace="2" src="<?php echo $this->baseurl;?>/components/com_rsappt_pro3/search.png" width="16" border="0" /></a>
                </div>
                </div>
            </td>
		</tr>
	...
	<?php 
		...
		foreach($pay_procs as $pay_proc){ 
			...
			if($who_to_show == "Yes" || in_array($who_to_show, $my_groups)){			
		    	...
		    	include JPATH_COMPONENT.DS."payment_processors".DS.$pay_proc->prefix.DS.$pay_proc->prefix."_fe_trans.php";
				$i2++;	
			}				
		}
