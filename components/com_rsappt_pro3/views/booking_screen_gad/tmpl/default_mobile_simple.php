...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	if($single_service_mode){
		...
		try{
			...
			logIt($e->getMessage(), "sb_tmpl_default_mobile", "", "");
...
<?php
	...
	if($thecount>0){ ?>
    <tr>
      <td><div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_SELECT_USER');?></div>
      <div class="controls"><select name="users" id="users" class="sv_apptpro_request_dropdown" onchange="changeUser();">
            <?php
			$k = 0;
			...
			?>
              ...
              </select> &nbsp;&nbsp;<label id="user_fetch" class="sv_apptpro_errors">&nbsp;</label></div>    </td>
    </tr>
<?php } ?>
    <tr>
      ...
      <div class="controls"><input name="name" type="text" id="name"  
           ...
           placeholder= '<?php echo JText::_('RS1_INPUT_SCRN_NAME_PLACEHOLDER');?>'             
            ...
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $user_id; ?>" /> <?php echo $required_symbol;?></div></td>
    </tr>
	<?php 
    ...
    <tr>
      <td><?php echo JText::_('RS1_INPUT_SCRN_SMS_LABEL');?><input type="checkbox" name="use_sms" id="use_sms" onchange="checkSMS();" class="sv_apptpro_request_text"/>&nbsp;
    ...
    <tr>
      ...
      <div class="controls"><input name="email" type="text" id="email" value="<?php echo $email ?>" 
           placeholder= '<?php echo JText::_('RS1_INPUT_SCRN_EMAIL_PLACEHOLDER');?>'             
              ...
              class="sv_apptpro_request_text"> <?php echo ($apptpro_config->requireEmail == "Yes"?$required_symbol:"")?></div></td>
    </tr>
	<?php } ?>
    <?php if(count($udf_rows > 0)){
        ...
        for($i=0; $i < count( $udf_rows ); $i++) {
        	...
        	?>
            <tr>
              <td><label id="<?php echo 'user_field'.$i.'_label'; ?>" class="control-label"><?php echo JText::_(stripslashes($udf_row->udf_label)) ?></label>
                <?php 
...
//					echo $udf_help_icon." title='".JText::_(stripslashes($udf_row->udf_help))."'>";
    ...
    <tr id="subcats_row" style="visibility:hidden; display:none"><td><div id="subcats_div"></div></td></tr>
	<?php } ?>
    <tr>
      <td><label id="resources_label" style="visibility:hidden;"><?php echo JText::_('RS1_INPUT_SCRN_RESOURCE');?></label><div id="resources_div" style="visibility:hidden;">&nbsp;</div></td>
    </tr>
    <?php } else { ?>
    <tr>
    ...
    <tr id="services" style="visibility:hidden; display:none">
      <td><?php echo JText::_('RS1_INPUT_SCRN_SERVICES');?><div id="services_div">&nbsp;</div></td>
    </tr>
    <tr id="resource_udfs" style="visibility:hidden; display:none">
    <td><div id="resource_udfs_div">&nbsp;</div></td>
    </tr>
	...
	<tr id="datetime" style="display: none">
      <td valign="top"> <div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_DATETIME');?></div>
      <div class="controls">
        ...
        <div class="controls" id="slots" style="visibility:hidden;">&nbsp;</div></div>
        </td>
	</tr>
    ...
    <tr id="booking_detail" style="visibility:hidden; display:none">
      <td><div class="control-label"><?php echo JText::_('RS1_GAD_SCRN_DETAIL');?></div>
      <div class="controls"><label class="sv_apptpro_errors" id="selected_resource_wait"></label>
      	<div>
          <label style="display: table-cell; " class="sv_apptpro_selected_resource" id="selected_starttime"></label>
          <label style="display: table-cell;" class="sv_apptpro_selected_resource"><?php echo JText::_('RS1_TO');?></label>
          <label style="display: table-cell;" class="sv_apptpro_selected_resource" id="selected_endtime"></label>
	   </div></div>
    </td>
    </tr>    
    ...
    <tr>
      ...
      <div id="calcResults" style="visibility:hidden; display:none; height:auto">
        <table border="1" align="left" class="calcResults_outside">
          ...
          <tr style="text-align:right">
            ...
            <div class="control-label" style="display: table-cell; padding-left:0px;"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></div>
            <div class="controls" style="display: table-cell; padding-left:5px;"><label id="res_rate"></label></div></div>
            </td>
            ...
            <div class="control-label" style="display: table-cell; padding-left:0px;"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></div>
            <div class="controls" style="display: table-cell; padding-left:5px;"><label id="res_total"></label></div></div></td>
          </tr>
	  ...
	  <?php } ?>
          <tr align="right">
			...
			<div class="controls" style="display: table-cell; padding-left:0px;"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></div>
            <div class="controls" style="display: table-cell; padding-left:5px;"><label id="res_grand_total"></label></div></td>
          </tr>
          <tr align="right" id="deposit_only">
			...
			<div class="controls" style="display: table-cell; padding-left:0px;"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></div>
            <div class="controls" style="display: table-cell; padding-left:5px;"><label id="display_deposit_amount"></label></div>
...
<?php } ?>
  ...
  <?php if($apptpro_config->allow_cancellation == 'Yes'){ ?>
	<tr align="center"><td>
        ...
        <tr >
          <td><?php echo JText::_('RS1_INPUT_SCRN_CANCEL_TEXT');?>
        ...
        <tr>          
          <td><div id="cancel_results">      </div></td>
        </tr>
        </table>
	</td></tr>
  <?php } ?>  
...
<input type='hidden' name="x_method" value="cc">
	...
	<input type="hidden" name="gad_mobile_simple" id="gad_mobile_simple" value="Yes" />    
