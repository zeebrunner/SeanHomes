...
<div id="sv_apptpro_request_gad" style="min-height:400px">
  <table style="margin:auto; width:100%">
	<?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "<tr><td colspan='4'><BR /><span class='sv_apptpro_errors'>".JText::_('RS1_INPUT_SCRN_LOGIN_REQUIRED')."</span></td></tr>";} ?> 
    <tr>
      <td colspan="4" class="booking_title"> <h3><?php echo JText::_('RS1_INPUT_SCRN_TITLE');?></h3></td>
    </tr>
    <tr>
...
<tbody id="wiztab1">
    ...
    <tr id="subcats_row"  class="category_selector" style="visibility:hidden; display:none"><td></td><td colspan="3"><div id="subcats_div"></div></td></tr>
	<?php } ?>
    ...
    <tr>
        <td colspan='4'>        
          <table class="sv_gad_container_table" id="gad_container" style="display:none; width:100%">
            <tr>
              <td colspan="2"><?php echo JText::_('RS1_GAD_SCRN_DATE');?> 

                <input name="grid_date" id="grid_date" type="hidden" 
                  class="sv_date_box" value="<?php echo $grid_date ?>" />
              ...
              <?php } else { ?>
                  <td style="text-align:right"><?php echo JText::_('RS1_GAD_SCRN_GRID_START');?>&nbsp;
                  <select name="gridstarttime" id="gridstarttime" class="sv_apptpro_request_dropdown" onchange="changeGrid();" style="width:auto">
                    ...
                    ?>
                    </select> &nbsp; <?php echo JText::_('RS1_GAD_SCRN_GRID_END');?> 
            ...
            <tr>
              <td colspan="4" style="margin:auto; width:<?php echo $gridwidth?>"><div id="table_here"></div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
    ...
    <td colspan="4" class="wiz_header_bar" style="text-align:right">
...
<tbody id="wiztab2" style="visibility:hidden; display:none;">
	...
	<?php } ?>
    <tr id="resource_udfs" style="visibility:hidden; display:none"><td colspan="4"><div id="resource_udfs_div"></div></td></tr>
...
<!--    <tr id="resource_seat_types" style="visibility:hidden; display:none"><td colspan="4"><div id="resource_seat_types_div"></div></td></tr>
    <tr id="resource_extras" style="visibility:hidden; display:none"><td colspan="4"><div id="resource_extras_div"></div></td></tr>
-->    <tr class="wiz_header_bar"><td colspan="4" class="wiz_header_bar">
    <span style="float:left"><?php echo JText::_('RS1_WIZARD_SCRN_2_HELP');?></span>
...
<?php // summary info.. ?>
	<tr>
    	<td ><?php echo JText::_('RS1_WIZARD_SCRN_SUMMARY');?></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_NAME');?> <label id="summary_name"></label></td>
	</tr>
	<tr>
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_EMAIL');?> <label id="summary_email"></label></td>
	</tr>
	<tr>
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_PHONE');?> <label id="summary_phone"></label></td>
	</tr>
    <?php if(count($res_cats) > 0 ){ ?>
	<tr>
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_CATEGORY');?> <label id="summary_cat"></label></td>
	</tr>
    <?php } ?>
	<tr>
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_RESOURCE');?> <label id="summary_resource"></label></td>
	</tr>    
	<tr id="service_summary" style="visibility:hidden; display:none">
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_SERVICE');?> <label id="summary_service"></label></td>
	</tr>
	<tr id="udfs_summary" style="visibility:hidden; display:none">
    	<td></td>
        <td colspan="3"><label id="summary_udfs"></label></td>
	</tr>
	<tr id="extras_summary" style="visibility:hidden; display:none">
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_EXTRAS');?> <label id="summary_extras"></label></td>
	</tr>
	<tr>
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_DATETIME');?> <label id="summary_datetime"></label></td>
	</tr>
	<tr id="summary_seats_row">
    	<td></td>
        <td colspan="3"><?php echo JText::_('RS1_WIZARD_SCRN_SEATS');?> <label id="summary_seats"></label></td>
	</tr>
 ...
 <?php if($pay_proc_enabled || $apptpro_config->non_pay_booking_button == "DAB" ||  $apptpro_config->non_pay_booking_button == "DO" ){ ?>
    <tr>
      <td class="sv_apptpro_request_label" style="vertical-align:top"><?php echo JText::_('RS1_WIZARD_SCRN_COST');?></td>
      <td colspan="3" style="vertical-align:top; height:auto">
      <div id="calcResults" style="visibility:hidden; display:none; height:auto">
        <table style="border:1px solid black; min-width:300px" class="calcResults_outside">
	  ...
	  <?php } ?>
          <tr style="text-align:right">
			...
			<div style="display: table-cell; padding-left:5px;"><?php echo JText::_('RS1_INPUT_SCRN_CURRENCY_SYMBOL');?></div><div style="display: table-cell; padding-left:5px;"><label id="res_grand_total"></label></div>
            </div>
            </td>
          </tr>
...
<?php } else { ?>        
	<?php if( ($apptpro_config->non_pay_booking_button == "Yes" || $pay_proc_enabled == false )
            && $apptpro_config->non_pay_booking_button != "DAB" ){  ?>
              <input type="submit" class="button"  name="submit1" id="submit1" onclick="return doSubmit(0);" 
                value="<?php echo JText::_('RS1_INPUT_SCRN_SUBMIT');?>" 
                  <?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "disabled";} ?> /> 
    <?php } ?>
    <?php if($apptpro_config->non_pay_booking_button == "DAB"){  ?>
              <input type="submit" class="button"  name="submit2" id="submit2" onclick="return doSubmit(1);" 
                value="<?php echo JText::_('RS1_INPUT_SCRN_SUBMIT');?>" 
                  <?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "disabled";} ?> /> 
...
<?php } ?>
    ...
    <tr class="wiz_header_bar"><td colspan="4" class="wiz_header_bar">
    <span style="float:left"><?php echo JText::_('RS1_WIZARD_SCRN_3_HELP');?></span>
  ...
  <?php } ?>  
    ...
    <tr>
      <td colspan="4"><div id="sv_footer"><?php echo JText::_($apptpro_config->footerText) ?></div></td>
    </tr>
  </table>
</div>
<?php 
