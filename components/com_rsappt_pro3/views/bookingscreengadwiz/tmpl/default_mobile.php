...
//	echo "Version:". substr( $VERSION->getShortVersion(), 0, 3 );
	...
	try{
		...
		logIt($e->getMessage(), "wiz_tmpl_default_mobile", "", "");
...
//			alert(result.replace(/<br>/gi, "\n"));
			jQuery("#wiz_alert_dialog").html(result.replace(/<br>/gi, "\n"));			
			wiz_alert_dialog.dialog( "option", "buttons", [ { text: "<?php echo JText::_('RS1_INPUT_SCRN_OK');?>", click: function() { jQuery( this ).dialog( "close" ); } } ] );
			...
			if(intExtrasCount>0){
				...
				for (x=0; x<intExtrasCount; x++){
					if(document.getElementById("extra_"+x).value != "0"){
						...
						strTable = strTable + document.getElementById(strName).innerHTML+":";
						strTable = strTable + "&nbsp;&nbsp;";
		...
		if(document.getElementById("udf_count")!= null || document.getElementById("res_udf_count")!= null){
			...
			if(intUDFsCount>0){
				// show udfs
				var strTable2 = "<table id='udf_summary_table' cellspacing=0 cellpadding=0 border=0>";
				for (x=0; x<intUDFsCount; x++){
					display_value = "";
//					switch(document.getElementById("user_field"+x+"_value").type){
...
<div id="sv_apptpro_request_gad_mobile" style="min-height:400px">
  <table width="95%" align="center" border="0" cellspacing="0" cellpadding="2" >
    ...
    <tr>
      <td align="center"><div id="sv_header"><?php echo JText::_($apptpro_config->headerText); ?></div></td>
    </tr>
...
<tbody id="wiztab1">
    ...
    <tr class="category_selector">
      <td>
	  <div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_RESOURCE_CATEGORIES');?></div>
    ...
    <tr id="subcats_row" class="category_selector" style="visibility:hidden; display:none"><td><div id="subcats_div"></div></td></tr>
	<?php } ?>
    <tr class="resource_selector">
      ...
      <div class="controls"><div id="resources_div" style="visibility:hidden;">&nbsp;</div></div></td>
    </tr>
    <?php } else { ?>
    <tr class="resource_selector">
      <td><div class="control-label"><label id="resources_label" style="visibility:hidden;"><?php echo JText::_('RS1_INPUT_SCRN_RESOURCE');?></label></div>
    ...
    <tr id="services"  class="service_selector" style="visibility:hidden; display:none">
      <td ><div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_SERVICES');?></div>
      <div class="controls"><div id="services_div">&nbsp;</div></div>
      </td>
    </tr>
    ...
    <tr>
        <td>        
          <table class="sv_gad_container_table" cellpadding="2" cellspacing="0" id="gad_container" style="display:none" width="100%">
            <tr>
              <td>
...
-->
            ...
            <tr>
              <td align="center" width="<?php echo $gridwidth?>"><div id="table_here"></div></td>
            </tr>
        </table>
    ...
    <td colspan="4" class="wiz_header_bar" align="right">
		<span style="float:left"><?php echo JText::_('RS1_WIZARD_SCRN_1_HELP');?></span>
<?php if($apptpro_config->cart_enable == "Yes" || $apptpro_config->cart_enable == "Public"){ ?>
        <input type="button" value="<?php echo JText::_('RS1_INPUT_SCRN_VIEW_CART');?>" onclick="viewCart(); return false;"
        <?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "disabled";} ?> />
<?php } ?>        
        <div style="display: table-cell; float:right"><input type="button" value="<?php echo JText::_('RS1_WIZARD_SCRN_NEXT');?>" onclick="gowiz2()";
        <?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "disabled";} ?> /></div>
    </td></tr>
...
<tbody id="wiztab2" style="visibility:hidden; display:none;">
    ...
    <tr>
      <td><div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_NAME');?></div>
  	  <div class="controls"><input name="name" type="text" id="name" class="sv_apptpro_request_text" 
           placeholder= '<?php echo JText::_('RS1_INPUT_SCRN_NAME_PLACEHOLDER');?>'             
            ...
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $user_id; ?>" /> <?php echo $required_symbol;?></div>
            </td>
    </tr>
	<?php 
    ...
    <?php } else { ?>   
    <tr>
      <td><div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_PHONE');?></div>
      <div class="controls"><input name="phone" type="text" id="phone" value="<?php echo $phone ?>" 
           <?php if($apptpro_config->phone_read_only == "Yes" /*&& $apptpro_config->phone_cb_mapping != ""*/){echo " readonly='readonly' ";}?>
             ...
             class="sv_apptpro_request_text"/> <?php echo ($apptpro_config->requirePhone == "Yes"?$required_symbol:"")?></div></td>
    </tr>
    <?php } ?>
    ...
    <tr>
      <td valign="top"><div class="control-label"><?php echo JText::_('RS1_INPUT_SCRN_SMS_LABEL');?></div>
      <div class="controls"><input type="checkbox" name="use_sms" id="use_sms" onchange="checkSMS();" class="sv_apptpro_request_text"/>&nbsp;
    ...
    <?php if(count($udf_rows > 0)){
        ...
        for($i=0; $i < count( $udf_rows ); $i++) {
            ...
            <tr>
              <td valign="top"><div class="control-label"><label id="<?php echo 'user_field'.$i.'_label'; ?>" class="sv_apptpro_request_text"><?php echo JText::_(stripslashes($udf_row->udf_label)) ?></label></div>
				<div class="controls">
               <?php 
...
//					echo $udf_help_icon." title='".JText::_(stripslashes($udf_row->udf_help))."'>";
		    ...
		    <tr>
	      		<td valign="top" class="sv_apptpro_request_helptext"><?php echo JText::_(stripslashes($udf_row->udf_help)) ?></td>
            </tr>
            <?php } ?>
          <?php $k = 1 - $k; 
		} ?>
    ...
    <div style="display: table-cell; float:left"><?php echo JText::_('RS1_WIZARD_SCRN_2_HELP');?></div>
    <div style="display: table-cell; float:right"><input type="button" value="<?php echo JText::_('RS1_WIZARD_SCRN_BACK');?>" onclick="gowiz1()";/>
    <input type="button" value="<?php echo JText::_('RS1_WIZARD_SCRN_NEXT');?>" onclick="gowiz3()";/></div></td></tr>

</tbody>
<tbody id="wiztab3" style="visibility:hidden; display:none;">
<?php // summary info.. ?>
	<tr>
    	<td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_SUMMARY');?></div>
        <div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_NAME');?></div><div class="controls"><label id="summary_name"/></div></td>
	</tr>
	<tr>
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_EMAIL');?></div><div class="controls"><label id="summary_email"/></div></td>
	</tr>
	<tr>
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_PHONE');?></div><div class="controls"><label id="summary_phone"/></div></td>
	</tr>
    <?php if(count($res_cats) > 0 ){ ?>
	<tr>
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_CATEGORY');?></div><div class="controls"><label id="summary_cat"/></div></td>
	</tr>
    <?php } ?>
	<tr>
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_RESOURCE');?></div><div class="controls"><label id="summary_resource"/></div></td>
	</tr>    
	<tr id="service_summary" style="visibility:hidden; display:none">
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_SERVICE');?></div><div class="controls"><label id="summary_service"/></div></td>
	</tr>
	...
	<tr id="extras_summary" style="visibility:hidden; display:none">
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_EXTRAS');?></div><div class="controls"><label id="summary_extras"/></div></td>
	</tr>
	<tr>
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_DATETIME');?></div><div class="controls"><label id="summary_datetime"/></div></td>
	</tr>
	<tr id="summary_seats_row">
        <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_SEATS');?></div><div class="controls"><label id="summary_seats"/></div></td>
	</tr>
	<tr>   	
        <td><hr /></td>
	</tr>
 ...
 <?php if($pay_proc_enabled || $apptpro_config->non_pay_booking_button == "DAB" ||  $apptpro_config->non_pay_booking_button == "DO" ){ ?>
    <tr>
      <td><div class="control-label"><?php echo JText::_('RS1_WIZARD_SCRN_COST');?></div>
...
<?php } ?>    
    ...
    <tr class="submit_section">
      <td colspan="4" valign="top" align="center" ><input  name="cbCopyMe" type="hidden" value="yes"  />
<?php if($apptpro_config->cart_enable == "Yes" || $apptpro_config->cart_enable == "Public"){ ?>
        <input type="button" class="button" id="btnAddToCart" value="<?php echo JText::_('RS1_INPUT_SCRN_ADD_TO_CART');?>" onclick="addToCart(); return false;"
        <?php if($apptpro_config->requireLogin == "Yes" && $user->guest){ echo "disabled";} ?> />
...
<?php } ?>
    ...
    <tr class="wiz_header_bar"><td class="wiz_header_bar">
    <div style="display: table-cell; float:left"><?php echo JText::_('RS1_WIZARD_SCRN_3_HELP');?></div>
    <div style="display: table-cell; float:right;"><input type="button" value="<?php echo JText::_('RS1_WIZARD_SCRN_BACK');?>" onclick="gowiz2()";/></div>
    </td></tr>
</tbody>
   </td></tr>
  ...
  <?php } ?>  
    ...
    <tr>
      <td valign="top" align="center"><div id="sv_footer"><?php echo JText::_($apptpro_config->footerText) ?></div></td>
    </tr>
  </table>
</div>
