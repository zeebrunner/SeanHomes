...
<table width="100%" >
  ...
  <table class="table table-striped" width="100%" >
    ...
    <?php if($fd_edit_status_only){?>
	    ...
	    <input type="hidden" size="20" maxsize="20" name="resource" <?php echo $readonly ?> value="<?php echo $this->detail->resource; ?>" /></div>
	<?php } else {?>
...
-->                  </tr>
    ...
    <tr>
      ...
      <div class="controls"<div id="svlabel"><?php echo $this->detail->invoice_number;?></div>
      </td>
    </tr>
    <tr>
      <td >
