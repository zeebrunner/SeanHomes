...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock <?php echo strtolower(preg_replace('/\s+/', '', K2HelperUtilities::cleanHtml($this->category->name))) ; ?>">
		...
		<?php if(isset($this->category) && ( $this->params->get('catImage') || $this->params->get('catTitle') || $this->params->get('catDescription') || $this->category->event->K2CategoryDisplay )): ?>
			...
			<!-- Category block -->
			<div class="itemListCategory childOfCat<?php echo $this->category->parent; ?> <?php echo strtolower(preg_replace('/\s+/', '', K2HelperUtilities::cleanHtml($this->category->name))) ; ?>">
	...
	<div class="itemList <?php echo strtolower(preg_replace('/\s+/', '', K2HelperUtilities::cleanHtml($this->category->name))) ; ?>">
		...
		<div id="itemListLeading">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> <?php echo $item->alias; ?>">
				<?php
