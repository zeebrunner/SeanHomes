...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> <?php echo $this->item->alias; ?>">
	...
	<div class="itemHeader cat<?php echo $this->item->catid; ?>">
  ...
  <div class="itemLinks cat<?php echo $this->item->catid; ?>">
	  ...
	  <div class="itemAttachmentsBlock">
	  	<?php if($this->item->catid==10) : ?>
		    <?php foreach ($this->item->attachments as $attachment): ?>
			    <a title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>" href="<?php echo $attachment->link; ?>"><span><?php echo JText::_('K2_DOWNLOAD_FLOORPLANS'); ?></span></a>
		    <?php endforeach; ?>
		<?php else : ?>
  ...
  <?php endif; ?>
   ...
   <div class="itemBody cat<?php echo $this->item->catid; ?>">
...
<?php if($this->item->catid==10) : ?>
	<div class="disclaimer"><?php echo JText::_('DISCLAIMER')." ".$this->item->metadesc; ?></div>
<?php endif; ?>
