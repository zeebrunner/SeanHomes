...
function modChrome_standard($module, &$params, &$attribs)
{
 	if (!empty ($module->content)) : ?>
		...
		<?php if(strpos($params->get('moduleclass_sfx'), 'guestsonly')) : ?>
			<?php if(!isset($_COOKIE['UBAM'])) : ?>
				<div id="ModuleChrome<?php echo $module->id; ?>" class="rt-block <?php if ($params->get('moduleclass_sfx')!='') : ?><?php echo $params->get('moduleclass_sfx'); ?><?php endif; ?>">
					<div class="module-surround">
			...
			<?php endif; ?>
		<?php elseif(strpos($params->get('moduleclass_sfx'), 'registeredonly')) : ?>
			<?php if(isset($_COOKIE['UBAM'])) : ?>
				<div id="ModuleChrome<?php echo $module->id; ?>" class="rt-block <?php if ($params->get('moduleclass_sfx')!='') : ?><?php echo $params->get('moduleclass_sfx'); ?><?php endif; ?>">
					<div class="module-surround">
						<?php if ($module->showtitle != 0) : ?>
